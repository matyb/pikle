...
{
    private static final long serialVersionUID = 4331100125022402235L;
    private String word = "";
	...
	public CodeDocument()
	{
		...
		//StyleConstants.setFontFamily(bold, "Courier"); 
	...
	private void checkForKeyword()
	{
		...
		if ((offs >= 0) && (offs <= strLen - 1))
		{
			...
			while (i > 0)
			{
				...
				i--;
				char charAt = elementText.charAt(i);
				if ((charAt == ' ') | (i == 0) | (charAt == '(') | (charAt == ')') | (charAt == '{') | (charAt == '}'))
	...
	private void processChar(String str)
	{
		...
		if (mode != CodeDocument.COMMENT_MODE)
		{
			mode = TEXT_MODE;
		}
		switch (strChar)
